	<div class="wrapper-side-bar hide-for-small show-for-large-up">
		<label for="">Unesp Foundation - Documentação</label>

		<ul class="side-nav">
			<li class="divider"></li>
			<li class="heading">Utilização</li>
			<li class="menu-docs-introducao"><a href="docs/">Introdução</a></li>

			<li class="divider"></li>

			<li class="heading">Estrutura</li>
			<li class="menu-docs-media-queries"><a href="docs/media-queries.html">Media Queries</a></li>
			<li class="menu-docs-componentes-visibilidade"><a href="docs/componentes/visibilidade.html">Visibilidade</a></li>
